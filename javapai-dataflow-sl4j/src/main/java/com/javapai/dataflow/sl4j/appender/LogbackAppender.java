...
//import com.github.danielwegener.logback.kafka.KafkaAppender.LazyProducer;
//import com.github.danielwegener.logback.kafka.delivery.FailedDeliveryCallback;
import com.javapai.dataflow.sl4j.config.KafkaAppenderConfig;
import com.javapai.dataflow.sl4j.delivery2.FailedDeliveryCallback;

import ch.qos.logback.classic.spi.ILoggingEvent;
import ch.qos.logback.core.Appender;
import ch.qos.logback.core.spi.AppenderAttachableImpl;

public class LogbackAppender<E> extends KafkaAppenderConfig<E> {
	/**
	 * Kafka clients uses this prefix for its slf4j logging. 
	 * <br>This appender defers appends of any Kafka logs since it could cause harmful infinite recursion/self feeding effects.
	 */
...
//    }
	...
	protected void append(E e) {
		...
		//暂时未考虑到 private static ExecutorService exec = Executors.newFixedThreadPool(5);exec.execute(producer.send(record));
		if (producer != null) {
